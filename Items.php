    ...
    <div class="row mb-3">
      ...
      <div class="col-sm-6">
        <ol class="breadcrumb float-sm-end">
          ...
          <li class="breadcrumb-item"><a href="customers.php">Items</a></li>
...
<form method="GET" class="mb-3">
  <div class="input-group">
    ...
    <a href="<?= BASE_URL ?>Items.php" class="btn btn-secondary">Reset</a>
  </div>
</form>


<div class="container">
  <h2 class="mb-4"><?= $edit_item ? 'Edit Item' : 'Tambah Item' ?></h2>
  ...
  <form method="post" action="controllers/ItemController.php">
    ...
    <div class="mb-3">
      ...
      <button type="submit" name="<?= $edit_item ? 'update_item' : 'add_item' ?>" class="btn btn-<?= $edit_item ? 'success' : 'primary' ?>">
        <?= $edit_item ? 'Update' : 'Tambah' ?>
      </button>
      <?php if ($edit_item): ?>
        <a href="<?= BASE_URL ?>Items.php" class="btn btn-secondary ms-2">Batal</a>
      <?php endif; ?>
    </div>
  </form>
...
<tbody>
  ...
  <tr>
    ...
    <td>
      <a href="Items.php?edit_id=<?= $item['id'] ?>" class="btn btn-sm btn-warning me-1">Edit</a>
