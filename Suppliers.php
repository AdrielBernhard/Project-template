...
if ($keyword !== '') {
    $stmt = $conn->prepare("SELECT * FROM suppliers WHERE name LIKE ? OR ref_no LIKE ? ORDER BY id ASC");
            ...
            <div class="row">
              ...
              <div class="col-sm-6">
                <ol class="breadcrumb float-sm-end">
                  ...
                  <li class="breadcrumb-item active" aria-current="page"><a href="Suppliers.php">Suppliers</a></li>
                </ol>
              </div>
            </div>
            <!--end::Row-->
...
<?php if (isset($_GET['status'])): ?>
    <div class="alert alert-<?= $_GET['status'] == 'duplicate' ? 'danger' : 'success' ?> alert-dismissible fade show">
        ...
        $messages = [
            ...
            'duplicate' => 'REF_NO sudah digunakan. Harap gunakan yang lain.'
        ];
...
<?php endif; ?>
            ...
            <!-- Suppliers Table -->
                ...
                <h3 class="card-title me-4 mb-0">Tabel Suppliers</h3>
                <a href="Suppliers_form.php" class="btn btn-success float-end">
                  <i class="fas fa-plus me-0"></i> Tambah Supplier
                </a>
    </div>
    <div class="card-body">
        <table class="table table-bordered">
            ...
            <tbody>
                <?php if (empty($suppliers)): ?>
                    <tr class="align-middle">
                        <td colspan="4" class="text-center">tidak ada supplier yang ditemukan</td>
                    </tr>
                <?php else: ?>
                    <?php foreach ($suppliers as $index => $supplier): ?>
                        <tr class="align-middle">
                            ...
                            <div class="d-flex gap-2">
                                    <a href="Suppliers_form.php?edit_id=<?= $supplier['id'] ?>" 
